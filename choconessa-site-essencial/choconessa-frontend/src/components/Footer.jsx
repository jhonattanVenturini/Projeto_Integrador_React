...
const Footer = () => {
  return (
    <footer className="bg-[#7A4636] text-white ">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-sm opacity-90 max-w-xs mx-auto md:mx-0">
              ...
              ingredientes para adoçar seus momentos especiais.
            </p>
          </div>
          ...
          <div className="text-center md:text-right">
            <h4 className="text-yellow-300 font-semibold text-lg mb-4">
              Contatos
            </h4>
        ...
        <div className="border-t border-white/20 mt-8 pt-6 text-center">
          <p className="text-sm opacity-75">
            © 2024 Choconessa. Todos os direitos reservados. Feito com ❤️ para
            adoçar sua vida.
          </p>
        </div>
      </div>
